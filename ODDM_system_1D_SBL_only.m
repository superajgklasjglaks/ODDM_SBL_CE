...
for ifram = 1:N_fram
    ...
    for iesn0 = 1:length(SNR_dB)
        ...
        %% 1D SBL Channel Estimation (Only method used)
...
legend('1D off-grid SBL');
xlabel('SNR(dB)')
ylabel('NMSE(dB)')
title('1D Sparse Bayesian Learning Channel Estimation Performance')
